...
<main>
	...
	<div class="margin-top text-align-center">
		<a class="btn-text btn-cancel" href="list">목록</a> <a
			class="btn-text btn-default" href="${n.id}/edit">수정</a> <a
			class="btn-text btn-default btn-del" href="${n.id}/del">삭제</a>
	</div>
